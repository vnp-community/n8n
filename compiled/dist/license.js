...
let License = class License {
    ...
    getAiCredits() {
        return this.getValue(constants_1.LICENSE_QUOTAS.AI_CREDITS) ?? constants_1.UNLIMITED_LICENSE_QUOTA;
    }
    ...
    getTeamProjectLimit() {
        return this.getValue(constants_1.LICENSE_QUOTAS.TEAM_PROJECT_LIMIT) ?? constants_1.UNLIMITED_LICENSE_QUOTA;
    }
    getPlanName() {
