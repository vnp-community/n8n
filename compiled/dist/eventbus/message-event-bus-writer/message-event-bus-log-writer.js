    ...
    static async getInstance(options) {
        if (!MessageEventBusLogWriter.instance) {
            ...
            MessageEventBusLogWriter.options = {
                logFullBasePath: (0, backend_common_1.safeJoinPath)(options?.logBasePath ?? di_1.Container.get(n8n_core_1.InstanceSettings).n8nFolder, options?.logBaseName ?? di_1.Container.get(config_1.GlobalConfig).eventBus.logWriter.logBaseName),
